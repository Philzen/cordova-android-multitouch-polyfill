 ...
 * @author philzen
 */
public class MultiTouchPolyfillWebViewClient extends CordovaWebViewClient {
	...
	public MultiTouchPolyfillWebViewClient(CordovaInterface cordova, CordovaWebView view) {
		super(cordova, view);
	}

	public MultiTouchPolyfillWebViewClient(CordovaInterface cordova) {
		super(cordova);
	}
...
//							android.util.Log.d("debug-console", EventJSON);
	 ...
	 * @return MultiTouchPolyfillWebViewClient (Fluent Interface)
	 */
	public MultiTouchPolyfillWebViewClient setPolyfillAllTouches(boolean polyfillAllTouches)  {
